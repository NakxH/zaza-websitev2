...
export const App = () => {
  return (
    <>
      ...
      />
      <ImageRight img="https://images.unsplash.com/photo-1499028344343-cd173ffc68a9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2940&q=80" />
      <TextWithPhotoRight
        isMenu={true}
        title="Menu"
        content="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
